Extension uses a very tiny square as icon. Apple crops this whitespace for both the action icon as well as other areas extension icons are used.
...
And:
https://github.com/lapcat/SafariExtensions/issues/56
